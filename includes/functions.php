 ...
 * accessors on {@see \FoxeLabs\LazyComments\Core}, so swapping the
...
if ( ! function_exists( 'lazy_load_for_comments_settings' ) ) {
	/**
	 * Get the shared {@see \FoxeLabs\LazyComments\Settings} instance.
	 *
	 ...
	 * @since 2.0.0
	 *
	 * @return \FoxeLabs\LazyComments\Settings
	 */
	function lazy_load_for_comments_settings() {
		return \FoxeLabs\LazyComments\Core::instance()->settings();
	}
}
